...
//             <label htmlFor="username" className='self-start mb-2'>Title</label>
//             <input type="text" id="username" placeholder='Title' className='w-full h-10 border-2 border-black rounded-lg pl-2 focus:outline-none focus:ring-2 focus:ring-blue-500'
//                 onChange={(e)=>{setTitle(e.target.value)}}
//             />


//             <label htmlFor="password" className='self-start mt-4 mb-2'>Description</label>
//             <input type="text" id="password" placeholder='About the Task' className='mt-2 w-full h-10 border-2 border-black rounded-lg pl-2 focus:outline-none focus:ring-2 focus:ring-blue-500'
//                 onChange={(e)=>{setDescription(e.target.value)}}
//             />
            
//             <div className='flex flex-row'>
//             <label htmlFor="complete" className='self-start mt-4 mb-2 mr-2'>Completed</label>
//             <input type="checkbox" id="complete"  className='mt-4 mb-2'
//                 onChange={(e)=>{setCompleted(e.target.checked)}}
//             />
//             </div>
